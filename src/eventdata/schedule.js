...
const scheduleItems = [
	...
	{
		title: 'Doors Open',
		description: 'When you arrive at the building on the morning of HackTJ, you will enter through the main door and check in the lobby. From there, you will be directed to the elevators and your designated floor. Please make sure that ALL team members check in individually! This year, we will be implementing <b>staggered check-ins</b>, so please check your email for time assignments.',
	...
	},
	{
		...
		description: 'If you are a beginner or don’t know where to start, come ask some HackTJ team members general questions about the hackathon!',
		time: dayjs('3/4/2023 12:30', timeFormat),
		end: dayjs('3/4/2023 13:00', timeFormat)
	},
	{
		title: 'Lunch',
		description: 'Potbelly Sandwiches: Italian, Turkey Swiss, Veggie<br />Panera Salads: Seasonal Greens, Greek, Caesar, Caesar with Chicken</li></ul>',
	...
	},
	{
		...
		description: 'Participants will be introduced to WebRTC, learning how to create a peer-to-peer video conferencing service and gain knowledge on how to expand and scale it for larger meetings, equipping them with the skills and confidence to build their own WebRTC applications. This workshop is ideal for those interested in real-time communication and building advanced applications.<br /><br />Recommended Level: Intermediate (some CS classes and basic knowledge of a programming language)',
	...
	},
	{
		...
		description: 'Join Children\'s National Hospital researchers Kevin Cleary and Hadi Fooladi Talari as they cover the relationship mobile app development has to the hospital.',
		time: dayjs('3/4/2023 14:00', timeFormat),
	...
	},
	{
		...
		description: 'Learn about how web servers and clients communicate, how web servers function, and the practical applications of these concepts through a presentation and demo by TJ Computer Security Club.<br /><br />Recommended Level: Intermediate (some CS classes and basic knowledge of a programming language)',
	...
	},
	{
		...
		description: 'Come create a website-based user interface for Arduino projects using Node.js with TJ Assistive Technology Club.<br /><br />Recommended Level: Advanced (many CS classes and comfortable with few languages) with a Basic knowledge of Arduino, HTML, and Javascript<br /><br /><b>Targeted to windows machines (discluding school laptops)</b>',
	...
	},
	{
		...
		description: 'Come to the workshop hosted by TJ’s Intermediate Computing team! Participants would learn about basic ASCL concepts and be introduced to USACO competition programming, as well as gain coding competition opportunities<br /><br />Recommended Level: Intermediate (some CS classes and basic knowledge of a programming language)',
		time: dayjs('3/4/2023 15:30', timeFormat),
	...
	},
	{
		...
		description: 'Interested about the fascinating field of Quantum Computing? Join Physaurus to learn about superposition through hands-on activity/game.<br /><br />Recommended Level: Beginner (little to no experience)',
	...
	},
	{
		...
		description: 'Learn how to use XCode to create iOS app drafts easily!<br /><br />Recommended Level: Beginner/Intermediate (some to no experience)<br /><br /><b>Participants will need a Mac that can run XCode (Come to the RED room 15 minutes in advance if you haven’t downloaded XCode)</b>',
	...
	},
	{
		...
		description: 'Join TJ Investment Club as they cover the basics of Value Proposition. Learn how to create a pitch that captures your audience and has them hooked. <br /><br />Recommended Level: Beginner (little to no experience)',
		time: dayjs('3/4/2023 17:00', timeFormat),
		end: dayjs('3/4/2023 18:00', timeFormat)
	},
	{
		...
		description: 'Come to TJ MUN’s Crash Course on Public Speaking to learn presentation tips and tricks that will WOW your judges!',
	...
	{
		title: 'Dinner',
		description: 'Noodles & Co.: Pad Thai, Vegetarian Spaghetti, Meat Spaghetti, Wisconsin Mac & Cheese, Korean Spicy Noodles, Pesto Cavatappi',
		time: dayjs('3/4/2023 19:00', timeFormat),
		end: dayjs('3/4/2023 20:00', timeFormat)
	},
	{
		title: 'Women in Tech Panel',
		description: 'Come to hear about the experiences, education/career paths, obstacles overcome, advice, and more of women working in technical fields. All student hackers are welcome to attend.',
	...
	},
	{
		...
		description: 'Come play off the stress of submitting your project in our nail-biting singles ping-pong tournament. Spots are limited to 35 people, so make sure to sign up fast!',
	...
	{
		title: 'Breakfast',
		description: 'Einstein Bros. Bagels: Honey, Blueberry, Chocolate Chip, Cinnamon Raisin, Plain, Everything<br /><br />Blueberry Muffins',
